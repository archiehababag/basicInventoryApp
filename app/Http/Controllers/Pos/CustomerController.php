...
class CustomerController extends Controller
{
    ...
    public function CustomerUpdate(Request $request)
    {
        ...
        if ($request->file('customer_image')) {
            ...
            $notification = array(
                'message' => 'Customer Information with Image Updated Successfully',
                'alert-type' => 'success'
            );
            ...
            $notification = array(
                'message' => 'Customer Information without Image Updated Successfully',
                'alert-type' => 'success'
            );
    ...
    {
        $allData = Payment::whereIn('paid_status', ['full due', 'partial_paid'])->get();
    ...
    public function CustomerUpdateInvoice(Request $request, $invoice_id)
    {
        if ($request->new_paid_amount < $request->paid_amount) {
            ...
            $notification = array(
                'message' => 'Payment Amount can not be more that Amount Due',
                'alert-type' => 'error'
            );
