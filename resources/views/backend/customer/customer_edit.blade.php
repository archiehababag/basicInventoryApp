            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" id="myForm" action="{{ route('customer.update') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <input type="submit" class="btn waves-effect waves-light" value="Update Customer Details" style="background-color: #c5d377">
