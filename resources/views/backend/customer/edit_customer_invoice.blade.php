            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('credit.customer') }}" class="btn btn-info btn-rounded waves-effect waves-light" style="float:right"><i class="fas fa-list"> Back</i></a>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="no-line"></td>
                                                            <td class="no-line text-center">
                                                                <strong>Balance Due</strong></td>
                                                                <input type="hidden" id="" name="new_paid_amount" value="{{ $payment->due_amount }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <div class="md-3">
                                                        ...
                                                        <input class="form-control example-date-input" name="date" type="date" placeholder="YYYY-MM-DD" id="date">
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-3">
