                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="md-3">
                                    ...
                                    <i class="btn btn-primary btn-rounded waves-effect waves-light fas fa-plus-circle addeventmore"> Add More</i>
                                </div>
                            </div>
                        ...
                        <form method="POST" action="{{ route('invoice.store') }}">
                            ...
                            <table class="table-sm table-bordered" width="100%" style="border-color: #ddd" >
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="discount_amount" id="discount_amount" class="form_control discount_amount" placeholder="Discount Amount">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="estimated_amount" value="0" id="estimated_amount" class="form_control estimated_amount" readonly style="background-color: #ddd">
                                        </td>
                                        <td></td>
                                    </tr>
                                </tbody>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <br>
                                    <input type="text" name="paid_amount" class="form-control paid_amount" placeholder="Enter Amount Paid" style="display: none">
                                </div>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-info" id="storeButton">Invoice Save</button>
                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        // Calucalte Invoice Total Amount
