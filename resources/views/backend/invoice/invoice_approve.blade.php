        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0"> Invoice For Approval List </h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Table</a></li>
                            <li class="breadcrumb-item active">All Invoices For Approval</li>
                        </ol>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('invoice.pending.list') }}" class="btn btn-info btn-rounded waves-effect waves-light" style="float:right"><i class="fas fa-list"> Pending Invoice List</i></a>
                        <br>
                        <br>
                        <br>
