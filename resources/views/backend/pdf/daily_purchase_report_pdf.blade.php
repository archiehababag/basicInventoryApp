                            ...
                            <div class="col-12">
                                <div>
                                    <div class="p-2">
                                        ...
                                        <span class="btn bnt-info">{{ date('d-m-Y',strtotime($start_date)) }}</span> -
                                        <span class="btn bnt-success">{{ date('d-m-Y',strtotime($end_date)) }}</span>    
                                        </strong></h3>
                                    </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end">${{ $item->buying_price }}</td>
                                                    </tr>
                                                    @php
