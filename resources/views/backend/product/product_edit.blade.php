            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" id="myForm" action="{{ route('product.update') }}" >
                            @csrf
                            ...
                            <input type="submit" class="btn waves-effect waves-light" value="Update Product Details" style="background-color: #c5d377">
