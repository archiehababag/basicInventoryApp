            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" id="myForm" action="{{ route('unit.update') }}" >
                            @csrf
                            ...
                            <input type="submit" class="btn waves-effect waves-light" value="Update Unit" style="background-color: #c5d377">
